...
import { ArrowLeft, Video, Clock, Calendar, MapPin, Users, Monitor, MessageSquare, Hand, Mic, MicOff, Camera, CameraOff, ScreenShare, Settings, Volume2, ShieldCheck } from "lucide-react";
import { useState } from "react";

// Professor calendar events (same as Calendar.tsx)
const profCalendarEvents = [
  { id: "pe1", title: "Matemática II", date: "2024-02-12", startTime: "08:00", endTime: "09:30", room: "Sala 101", turma: "2º Ano Informática", disciplineId: "pd1", color: "hsl(224, 64%, 33%)" },
  { id: "pe2", title: "Matemática I", date: "2024-02-12", startTime: "10:00", endTime: "11:30", room: "Sala 203", turma: "1º Ano Informática", disciplineId: "pd2", color: "hsl(175, 84%, 32%)" },
  { id: "pe3", title: "Matemática II", date: "2024-02-12", startTime: "14:00", endTime: "15:30", room: "Sala 101", turma: "2º Ano Eng. Civil", disciplineId: "pd1", color: "hsl(224, 64%, 33%)" },
  { id: "pe4", title: "Estatística", date: "2024-02-13", startTime: "14:00", endTime: "15:30", room: "Sala 105", turma: "2º Ano Informática", disciplineId: "pd3", color: "hsl(25, 95%, 53%)" },
  { id: "pe5", title: "Matemática II", date: "2024-02-14", startTime: "08:00", endTime: "09:30", room: "Sala 101", turma: "2º Ano Informática", disciplineId: "pd1", color: "hsl(224, 64%, 33%)" },
  { id: "pe6", title: "Matemática I", date: "2024-02-14", startTime: "10:00", endTime: "11:30", room: "Sala 203", turma: "1º Ano Informática", disciplineId: "pd2", color: "hsl(175, 84%, 32%)" },
  { id: "pe7", title: "Matemática II", date: "2024-02-14", startTime: "14:00", endTime: "15:30", room: "Sala 101", turma: "2º Ano Eng. Civil", disciplineId: "pd1", color: "hsl(224, 64%, 33%)" },
  { id: "pe8", title: "Estatística", date: "2024-02-14", startTime: "16:00", endTime: "17:30", room: "Sala 105", turma: "2º Ano Informática", disciplineId: "pd3", color: "hsl(25, 95%, 53%)" },
  { id: "pe9", title: "Matemática I", date: "2024-02-15", startTime: "10:00", endTime: "11:30", room: "Sala 203", turma: "1º Ano Informática", disciplineId: "pd2", color: "hsl(175, 84%, 32%)" },
  { id: "pe10", title: "Matemática II", date: "2024-02-16", startTime: "08:00", endTime: "09:30", room: "Sala 101", turma: "2º Ano Informática", disciplineId: "pd1", color: "hsl(224, 64%, 33%)" },
  { id: "pe11", title: "Estatística", date: "2024-02-16", startTime: "14:00", endTime: "15:30", room: "Sala 105", turma: "2º Ano Informática", disciplineId: "pd3", color: "hsl(25, 95%, 53%)" },
];

export default function ProfessorClassLobby() {
  const [searchParams] = useSearchParams();
  const eventId = searchParams.get("eventId");
  const event = profCalendarEvents.find(e => e.id === eventId);
  ...
  if (!event) {
    return (
      <div className="p-8 text-muted-foreground">
        <Link to="/professor/calendar" className="text-primary hover:underline">← Voltar ao Calendário</Link>
  ...
  return (
    <div className="p-6 lg:p-8 animate-fade-in max-w-6xl mx-auto">
      <Link to="/professor/calendar" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors mb-5">
          ...
          <div className="flex items-start gap-4 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <Badge variant="outline" className="text-[10px] ml-2 gap-1 border-primary/30 text-primary">
                  <ShieldCheck className="w-3 h-3" /> Docente
                </Badge>
              </div>
              <h1 className="text-xl font-bold text-foreground truncate">{event.title}</h1>
              <p className="text-xs text-muted-foreground mt-0.5">{event.turma}</p>
            </div>
          </div>
        ...
        <div className="lg:col-span-2 space-y-4">
            ...
            <div className="text-center">
              {camOn ? (
                <>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Modo Docente — A gravação iniciará automaticamente</p>
                </>
              ) : (
                <>
          ...
          <Card className="p-3 border">
            <div className="flex items-center justify-center gap-2 flex-wrap">
              ...
              <Button variant={micOn ? "outline" : "destructive"} size="icon" className="w-11 h-11 rounded-full" onClick={() => setMicOn(!micOn)} title={micOn ? "Desligar microfone" : "Ligar microfone"}>
                {micOn ? <Mic className="w-5 h-5" /> : <MicOff className="w-5 h-5" />}
              </Button>
              <Button variant={camOn ? "outline" : "destructive"} size="icon" className="w-11 h-11 rounded-full" onClick={() => setCamOn(!camOn)} title={camOn ? "Desligar câmara" : "Ligar câmara"}>
              ...
              <Button size="lg" className="gap-2 px-8 rounded-full">
                <Video className="w-5 h-5" /> Iniciar Aula
              </Button>
            </div>
          </Card>
        </div>
        ...
        <div className="space-y-4">
          <Card className="p-4 border">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-sm font-bold text-foreground">Estudantes</h3>
