            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <div className="flex items-center gap-2 flex-wrap mt-3">
                  ...
                  <Badge variant="outline" className="text-[11px] bg-background/80">{turma.name}</Badge>
                  <Badge variant="outline" className="text-[11px] bg-background/80">{turma.year}º Ano</Badge>
                  <Badge variant="outline" className="text-[11px] bg-background/80">{task.type === "quiz" ? "Quiz" : task.type === "exame" ? "Exame" : "Tarefa"}</Badge>
                </div>
              </div>
              <Badge className={`${sStyle.bg} gap-1.5 text-[11px] border-0 px-2.5 py-1 shrink-0 mt-1`}>
