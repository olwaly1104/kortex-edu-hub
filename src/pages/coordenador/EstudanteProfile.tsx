          ...
          <PopoverContent align="end" className="w-72 p-0 overflow-hidden">
            ...
            <div className="p-1.5">
              {[
                ...
                <button
                  key={r.id}
                  onClick={() => { setReportType(r.id); setReportMenuOpen(false); }}
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-1.5 flex-wrap mt-2">
                  ...
                  <Link to="/coordenador/curso">
                    <Badge variant="outline" className="text-[10px] gap-1 hover:bg-muted/50"><GraduationCap className="w-3 h-3" /> {coordCursoInfo.code}</Badge>
                  </Link>
