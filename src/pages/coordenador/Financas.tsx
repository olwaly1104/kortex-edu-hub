...
const salaryHistory = [
  { month: "Janeiro 2025", gross: 320000, net: 281600, date: "31 Jan 2025", status: "paid" as const },
  { month: "Fevereiro 2025", gross: 320000, net: 281600, date: "28 Fev 2025", status: "paid" as const },
  { month: "Março 2025", gross: 320000, net: 281600, date: "31 Mar 2025", status: "pending" as const },
  { month: "Abril 2025", gross: 320000, net: 281600, date: "30 Abr 2025", status: "pending" as const },
  { month: "Maio 2025", gross: 320000, net: 281600, date: "31 Mai 2025", status: "pending" as const },
  { month: "Junho 2025", gross: 320000, net: 281600, date: "30 Jun 2025", status: "pending" as const },
  { month: "Julho 2025", gross: 320000, net: 281600, date: "31 Jul 2025", status: "pending" as const },
  { month: "Agosto 2025", gross: 320000, net: 281600, date: "31 Ago 2025", status: "pending" as const },
  { month: "Setembro 2025", gross: 320000, net: 281600, date: "30 Set 2025", status: "pending" as const },
  { month: "Outubro 2025", gross: 320000, net: 281600, date: "31 Out 2025", status: "pending" as const },
  { month: "Novembro 2025", gross: 320000, net: 281600, date: "30 Nov 2025", status: "pending" as const },
  { month: "Dezembro 2025", gross: 320000, net: 281600, date: "31 Dez 2025", status: "pending" as const },
];

const deductions = [
  { label: "IRT (Imposto)", percentage: "8%", amount: 25600 },
  { label: "Segurança Social", percentage: "3%", amount: 9600 },
  { label: "Seguro de Saúde", percentage: "1%", amount: 3200 },
];

const multas = [
  { id: "m1", date: "10 Fev 2025", reason: "Atraso na entrega de relatório", amount: 4000, status: "aplicada" as const, details: "Relatório semestral entregue com 4 dias de atraso." },
  { id: "m2", date: "18 Jan 2025", reason: "Falta injustificada à reunião", amount: 6000, status: "pendente" as const, details: "Ausência na reunião de coordenação de 18/01/2025." },
];
...
export default function CoordenadorFinancas() {
    ...
    <div className="p-6 lg:p-8 max-w-5xl mx-auto space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="rounded-xl border border-border bg-card p-5">
          ...
          <p className="text-xl font-bold text-foreground">{formatCurrency(320000)}</p>
        </div>
        <div className="rounded-xl border border-border bg-card p-5">
          <div className="flex items-center gap-3 mb-3">
          ...
          <p className="text-xl font-bold text-foreground">{formatCurrency(281600)}</p>
        </div>
        <div className="rounded-xl border border-border bg-card p-5">
          <div className="flex items-center gap-3 mb-3">
