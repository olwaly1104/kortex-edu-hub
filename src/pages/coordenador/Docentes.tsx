      ...
      <Card className="overflow-hidden">
        <table className="w-full text-sm">
          <thead><tr className="border-b bg-muted/30">
            ...
            <th className="text-center p-3 font-medium text-muted-foreground">Taxa Conclusão</th>
          ...
          <tbody>{filtered.map(d => {
            ...
            return (
              <tr key={d.id} className="border-b last:border-0 hover:bg-muted/20 cursor-pointer" onClick={() => navigate(`/coordenador/docentes/${d.id}`)}>
                ...
                <td className="p-3 text-center"><span className="text-foreground font-medium">{Math.round((d.taxaAprovacao + d.taxaEntrega) / 2)}%</span></td>
