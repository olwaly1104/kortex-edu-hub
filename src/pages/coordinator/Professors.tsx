  ...
  return (
    <div className="p-6 lg:p-8 space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-muted-foreground mt-1">{mockProfessors.length} professores nas disciplinas do curso</p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <Card className="p-4 flex items-center gap-4">
          ...
          <div><p className="text-2xl font-bold text-foreground">{profDisciplines.length}</p><p className="text-xs text-muted-foreground">Disciplinas</p></div>
        </Card>
        <Card className="p-4 flex items-center gap-4">
