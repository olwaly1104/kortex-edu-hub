...
import { coordAgendaEvents } from "@/data/mockData";
...
// Decano-specific events
const decanoEvents = [
  { id: "de1", title: "Reunião Conselho Directivo", type: "pessoal" as const, date: "2024-02-12", startTime: "09:00", endTime: "10:30", duration: "1h 30min", room: "Sala de Reuniões A", color: "hsl(220, 70%, 50%)" },
  { id: "de2", title: "Avaliação Coordenadores", type: "pessoal" as const, date: "2024-02-12", startTime: "14:00", endTime: "16:00", duration: "2h", room: "Gabinete do Decano", color: "hsl(160, 60%, 40%)" },
  { id: "de3", title: "Reunião com Reitoria", type: "pessoal" as const, date: "2024-02-13", startTime: "10:00", endTime: "12:00", duration: "2h", room: "Reitoria — Sala 1", color: "hsl(340, 70%, 50%)" },
  { id: "de4", title: "Análise Orçamental 2024", type: "pessoal" as const, date: "2024-02-13", startTime: "14:00", endTime: "15:30", duration: "1h 30min", room: "Gabinete do Decano", color: "hsl(30, 70%, 50%)" },
  { id: "de5", title: "Reunião Conselho Pedagógico", type: "pessoal" as const, date: "2024-02-14", startTime: "08:30", endTime: "10:00", duration: "1h 30min", room: "Sala de Reuniões B", color: "hsl(220, 70%, 50%)" },
  { id: "de6", title: "Recepção Delegação Internacional", type: "pessoal" as const, date: "2024-02-14", startTime: "10:30", endTime: "12:00", duration: "1h 30min", room: "Auditório Principal", color: "hsl(270, 60%, 50%)" },
  { id: "de7", title: "Revisão Planos de Estudo", type: "pessoal" as const, date: "2024-02-14", startTime: "14:00", endTime: "16:00", duration: "2h", room: "Gabinete do Decano", color: "hsl(160, 60%, 40%)" },
  { id: "de8", title: "Audiência com Estudantes", type: "pessoal" as const, date: "2024-02-14", startTime: "16:30", endTime: "17:30", duration: "1h", room: "Gabinete 101", color: "hsl(30, 70%, 50%)" },
  { id: "de9", title: "Reunião Comissão Científica", type: "pessoal" as const, date: "2024-02-15", startTime: "09:00", endTime: "11:00", duration: "2h", room: "Sala de Reuniões A", color: "hsl(220, 70%, 50%)" },
  { id: "de10", title: "Supervisão Infraestruturas", type: "pessoal" as const, date: "2024-02-15", startTime: "14:00", endTime: "15:30", duration: "1h 30min", room: "Campus", color: "hsl(340, 70%, 50%)" },
  { id: "de11", title: "Entrevista Novos Docentes", type: "pessoal" as const, date: "2024-02-16", startTime: "10:00", endTime: "12:00", duration: "2h", room: "Sala de Reuniões C", color: "hsl(270, 60%, 50%)" },
];

export default function DecanoCalendar() {
  const [view, setView] = useState<"week" | "month">("week");
  const [selectedDate, setSelectedDate] = useState<string>(TODAY_DATE);
  const [selectedEvent, setSelectedEvent] = useState<string | null>(null);

  const allEvents = decanoEvents;
  const selectedDayEvents = allEvents.filter(e => e.date === selectedDate);
  const totalHeight = (HOURS.length - 1) * HOUR_HEIGHT;
  const selected = allEvents.find(e => e.id === selectedEvent);
            ...
            <Card className="overflow-hidden">
              ...
              <div className="p-4 space-y-3">
                <div className="flex items-start justify-between">
                  <div>
                    <Badge className="text-[10px] mb-1.5" style={{ backgroundColor: selected.color + "20", color: selected.color, border: "none" }}>Evento</Badge>
                ...
                <div className="space-y-2 text-xs">
                  ...
                  <div className="flex items-center gap-2 text-muted-foreground"><Clock className="w-3.5 h-3.5" /><span>{selected.startTime} – {selected.endTime}</span>{selected.duration && <span className="text-muted-foreground/60">({selected.duration})</span>}</div>
