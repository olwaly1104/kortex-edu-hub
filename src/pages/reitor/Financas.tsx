...
const salaryHistory = [
  { month: "Janeiro 2025", gross: 850000, net: 731000, date: "31 Jan 2025", status: "paid" as const },
  { month: "Fevereiro 2025", gross: 850000, net: 731000, date: "28 Fev 2025", status: "paid" as const },
  { month: "Março 2025", gross: 850000, net: 731000, date: "31 Mar 2025", status: "pending" as const },
  { month: "Abril 2025", gross: 850000, net: 731000, date: "30 Abr 2025", status: "pending" as const },
  { month: "Maio 2025", gross: 850000, net: 731000, date: "31 Mai 2025", status: "pending" as const },
  { month: "Junho 2025", gross: 850000, net: 731000, date: "30 Jun 2025", status: "pending" as const },
  { month: "Julho 2025", gross: 850000, net: 731000, date: "31 Jul 2025", status: "pending" as const },
  { month: "Agosto 2025", gross: 850000, net: 731000, date: "31 Ago 2025", status: "pending" as const },
  { month: "Setembro 2025", gross: 850000, net: 731000, date: "30 Set 2025", status: "pending" as const },
  { month: "Outubro 2025", gross: 850000, net: 731000, date: "31 Out 2025", status: "pending" as const },
  { month: "Novembro 2025", gross: 850000, net: 731000, date: "30 Nov 2025", status: "pending" as const },
  { month: "Dezembro 2025", gross: 850000, net: 731000, date: "31 Dez 2025", status: "pending" as const },
];

const deductions = [
  { label: "IRT (Imposto)", percentage: "8%", amount: 68000 },
  { label: "Segurança Social", percentage: "3%", amount: 25500 },
  { label: "Seguro de Saúde", percentage: "1%", amount: 8500 },
  { label: "Subsídio de Representação", percentage: "+5%", amount: -42500 },
];

const multas = [
  { id: "m1", date: "10 Fev 2025", reason: "Atraso na entrega do relatório anual ao Ministério", amount: 15000, status: "aplicada" as const, details: "Relatório anual de actividade da Reitoria entregue com 8 dias de atraso." },
];
...
export default function ReitorFinancas() {
    ...
    <div className="p-6 lg:p-8 max-w-5xl mx-auto space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="rounded-xl border border-border bg-card p-5">
          ...
          <p className="text-xl font-bold text-foreground">{formatCurrency(850000)}</p>
        </div>
        <div className="rounded-xl border border-border bg-card p-5">
          <div className="flex items-center gap-3 mb-3">
          ...
          <p className="text-xl font-bold text-foreground">{formatCurrency(731000)}</p>
        </div>
        <div className="rounded-xl border border-border bg-card p-5">
          <div className="flex items-center gap-3 mb-3">
