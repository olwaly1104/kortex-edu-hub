      ...
      <div className="divide-y">
        ...
        {impostos.length === 0 ? (
          ...
          <div key={i.id} className="grid grid-cols-[1fr_140px_180px_40px] gap-3 px-5 py-2.5 items-center text-sm">
            ...
            <Input type="number" min={0} max={1} step={0.01} className="h-9 tabular-nums" value={i.taxa}
              onChange={(e) => setImpostos((s) => s.map((x) => x.id === i.id ? { ...x, taxa: Number(e.target.value) } : x))} />
