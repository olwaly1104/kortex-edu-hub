...
const GROUPS: Group[] = [
  ...
  },
  {
    ...
    icon: School,
    steps: [
      { key: "aca.cal", title: "Ano letivo & calendário", desc: "Definir ano letivo, semestres e feriados antes de tudo.", icon: CalendarDays, path: "/areaacademica/criador/calendario?step=aca.cal" },
