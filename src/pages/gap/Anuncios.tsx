...
const initialMyAnnouncements: MyAnnouncement[] = [
  {
    id: "g1",
    title: "Sessões de Apoio Psicopedagógico — Inscrições Abertas",
    content: "Estão abertas as inscrições para as sessões individuais de apoio psicopedagógico. Os discentes interessados devem dirigir-se ao GAP ou solicitar agendamento através da plataforma.",
    type: "academico",
    date: "13/02/2024",
    time: "10:15",
    status: "publicado",
  ...
  {
    id: "g2",
    title: "Workshop — Gestão de Ansiedade em Época de Avaliações",
    content: "O GAP realizará um workshop gratuito sobre gestão da ansiedade dirigido a todos os discentes do 2.º semestre. Inscrição obrigatória pela plataforma.",
    type: "evento",
    date: "11/02/2024",
    time: "09:00",
    status: "publicado",
  ...
  {
    id: "g3",
    title: "Atendimento Urgente — Alteração de Horário",
    content: "O atendimento urgente do GAP funcionará excepcionalmente das 09h às 13h durante esta semana, devido a formação interna da equipa.",
    type: "urgente",
    date: "09/02/2024",
    time: "08:30",
    status: "publicado",
...
export default function GapAnuncios() {
    ...
    <div className="p-6 lg:p-8 space-y-6 animate-fade-in">
      ...
      <div className="flex gap-1 border-b border-border">
        {([
          ...
          { key: "meus" as const, label: "Anúncios do GAP", icon: User, count: 0 },
        ]).map(tab => (
          <button
            key={tab.key}
          ...
          {myAnns.length === 0 && (
            <Card className="border-dashed border-2 border-border">
              <div className="text-center py-14">
                ...
                <p className="text-xs text-muted-foreground mb-4">Crie o primeiro anúncio do GAP para comunicar com a comunidade académica.</p>
      ...
      <Dialog open={showCreate} onOpenChange={setShowCreate}>
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>Publique um comunicado do GAP para a comunidade académica.</DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-2">
            <div className="space-y-1.5">
              <Label htmlFor="ann-title">Título</Label>
              <Input id="ann-title" placeholder="Ex: Sessões de Apoio Psicopedagógico" value={newTitle} onChange={e => setNewTitle(e.target.value)} />
            </div>
            <div className="space-y-1.5">
