          ...
          <DialogContent className="max-w-2xl p-0 gap-0 max-h-[92vh] overflow-y-auto rounded-xl">
            ...
            <div className="px-6 pt-5 pb-4 border-b">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <DialogTitle className="text-lg font-bold leading-tight">Novo Agendamento</DialogTitle>
                  <p className="text-xs text-muted-foreground mt-0.5">Marcar uma sessão de apoio individual</p>
                </div>
              </div>
            </div>
            ...
            <div className="px-6 py-5 space-y-5">
              ...
              <section className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="text-[11px] font-semibold uppercase tracking-wider text-muted-foreground">Estudante</h4>
                </div>
                <div className="space-y-1.5">
                  <Label className="text-xs font-medium">Nome ou matrícula</Label>
                  <Input placeholder="Ex: Ana Silva ou 2934" className="h-9" />
                </div>
              </section>
              ...
              <section className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="text-[11px] font-semibold uppercase tracking-wider text-muted-foreground">Detalhes da Sessão</h4>
                </div>
                <div className="space-y-1.5">
                  <Label className="text-xs font-medium">Motivo</Label>
                  <Textarea placeholder="Descreva brevemente o motivo da sessão..." className="resize-none text-sm" rows={3} />
                </div>
              ...
              <section className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="text-[11px] font-semibold uppercase tracking-wider text-muted-foreground">Quando & Onde</h4>
                </div>
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Select>
                      <SelectTrigger className="h-9"><SelectValue placeholder="50 min" /></SelectTrigger>
                      <SelectContent>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    ...
                    <Select>
                      <SelectTrigger className="h-9"><SelectValue placeholder="Presencial" /></SelectTrigger>
                      <SelectContent>
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-xs font-medium">Local / Sala</Label>
                    <Input placeholder="Ex: Gabinete GAP 2" className="h-9" />
                  </div>
                </div>
              </section>
            </div>
