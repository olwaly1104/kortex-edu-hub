...
export const profTasks: ProfTask[] = [
  // Matemática II - t1
  { id: "pt1", disciplineId: "pd1", turmaId: "t1", title: "Exercícios Integrais Indefinidos", description: "Resolver exercícios 1-10 do capítulo 3.", dueDate: "08/02/2024", assignedDate: "05/02/2024", type: "tarefa", status: "encerrada", submissions: 42, totalStudents: 45, avgGrade: 14.5, weight: 15, modality: "online" },
  { id: "pt2", disciplineId: "pd1", turmaId: "t1", title: "Integração por Partes", description: "Resolver 5 integrais usando integração por partes.", dueDate: "12/02/2024", assignedDate: "08/02/2024", type: "tarefa", status: "encerrada", submissions: 40, totalStudents: 45, avgGrade: 13.8, weight: 15, modality: "online" },
  ...
  { id: "pt4", disciplineId: "pd1", turmaId: "t1", title: "Séries Geométricas", description: "Determinar convergência de 8 séries.", dueDate: "19/02/2024", assignedDate: "15/02/2024", type: "tarefa", status: "publicada", submissions: 28, totalStudents: 45, avgGrade: null, weight: 20, modality: "online" },
  { id: "pt5", disciplineId: "pd1", turmaId: "t1", title: "Quiz - Critérios de Convergência", description: "Quiz online de 20 minutos.", dueDate: "23/02/2024", assignedDate: "19/02/2024", type: "quiz", status: "publicada", submissions: 15, totalStudents: 45, avgGrade: null, weight: 10, modality: "online" },

  // Matemática II - t3
  { id: "pt9", disciplineId: "pd1", turmaId: "t3", title: "Exercícios Integrais Indefinidos", description: "Resolver exercícios 1-10 do capítulo 3.", dueDate: "09/02/2024", assignedDate: "06/02/2024", type: "tarefa", status: "encerrada", submissions: 27, totalStudents: 30, avgGrade: 12.0, weight: 15, modality: "online" },
  { id: "pt10", disciplineId: "pd1", turmaId: "t3", title: "Integração por Partes", description: "Resolver 5 integrais usando integração por partes.", dueDate: "13/02/2024", assignedDate: "09/02/2024", type: "tarefa", status: "publicada", submissions: 18, totalStudents: 30, avgGrade: null, weight: 15, modality: "online" },

  // Matemática I - t2
  { id: "pt6", disciplineId: "pd2", turmaId: "t2", title: "Exercícios de Limites", description: "Calcular limites de 15 funções.", dueDate: "10/02/2024", assignedDate: "06/02/2024", type: "tarefa", status: "encerrada", submissions: 50, totalStudents: 52, avgGrade: 13.2, weight: 15, modality: "online" },
  ...
  // Estatística - t1
  { id: "pt8", disciplineId: "pd3", turmaId: "t1", title: "Exercícios de Probabilidade", description: "Resolver problemas de probabilidade condicional.", dueDate: "14/02/2024", assignedDate: "07/02/2024", type: "tarefa", status: "encerrada", submissions: 41, totalStudents: 45, avgGrade: 14.0, weight: 15, modality: "online" },

  // Álgebra Linear - t4
  { id: "pt11", disciplineId: "pd4", turmaId: "t4", title: "Exercícios de Matrizes", description: "Resolver operações com matrizes 3x3.", dueDate: "10/02/2024", assignedDate: "05/02/2024", type: "tarefa", status: "encerrada", submissions: 35, totalStudents: 38, avgGrade: 13.5, weight: 15, modality: "online" },
