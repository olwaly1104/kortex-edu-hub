...
export const lessons: Lesson[] = [
  ...
  { id: "l10", disciplineId: "4", title: "Ligações Químicas", number: 2, professor: "Prof. Ana Costa", uploadDate: "09/02/2024", date: "09/02/2024", duration: "1h 25min", progress: 60, summary: "Ligações iónicas, covalentes e metálicas. Geometria molecular e teoria VSEPR.", materials: [{ name: "Slides Ligações", type: "pdf" }], transcript: "Hoje vamos estudar os diferentes tipos de ligações químicas e como estas determinam as propriedades das substâncias...", participants: ["Prof. Ana Costa", "João Fernandes", "Maria Silva", "Pedro Nascimento"], tasks: [{ id: "t8", title: "Exercícios sobre ligações químicas", description: "Resolver os exercícios 1-15 do capítulo 4 sobre tipos de ligações e geometria molecular.", assignedDate: "09/02/2024", dueDate: "13/02/2024", status: "entregue", modality: "online", weight: 10, grade: 13 }] },
...
export const grades: Grade[] = [
  ...
  { id: "g2", disciplineId: "3", disciplineName: "Programação II", evaluations: [
    { name: "Projecto 1", grade: 17, maxGrade: 20, weight: 20, date: "10/02/2024", published: true, modality: "online", description: "Projecto de implementação de estruturas de dados básicas em Java: listas ligadas e pilhas.", topics: ["Listas ligadas", "Pilhas", "Testes unitários"], allowedMaterials: "IDE, documentação Java" },
